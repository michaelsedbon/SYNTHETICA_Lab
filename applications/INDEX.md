...
All lab applications live under this directory. Each app has a `README.md` and a `CATCHUP.md` (living changelog).

| App | Slug | Port(s) | Status | Description |
|-----|------|---------|--------|-------------|
| ADC-24 Electrophysiology | `adc24-dashboard` | 8000 (API) · 3001 (UI) | ✅ Working | Real-time fungal electrophysiology dashboard (Mishra et al. 2024) |
