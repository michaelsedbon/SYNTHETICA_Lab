...
### 4.1 Validation — 30-Minute Simulation

A 30-minute simulation at dt = 0.01 s (30,000 steps) with no light stimulation:
...
### 4.2 UV Intensity Sweep

UV pulse of 2 s at t=150 s, height=12 cm:

| Intensity | Max amplitude | Paper reference |
|-----------|---------------|-----------------|
| 0.1 W/cm² | 341 µV (~2.5×) | 25 ± 4 µV at Plate 1 |
| 0.5 W/cm² | 480 µV (~3.6×) | — |
| 1.0 W/cm² | 1299 µV (~9.7×) | 281 ± 14 µV at Plate 1, up to 18,569 at Plate 2 |

Amplification ratio spans 2.5–9.7×, within the reported 3–10× range.

### 4.3 Robot Control Protocol

Simulating the robot control protocol from the paper — *"UV light for 1 s at a 20-s interval"* (p.7):
...
The repeated UV pulses modulate the spike train without fundamentally changing the statistics — consistent with the paper's observation that UV acts as a superimposed signal on top of the spontaneous baseline.
